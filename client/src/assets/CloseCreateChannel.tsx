...
interface CloseCreateChannelProps {
  setIsCreating: (prevState: boolean) => void;
  setIsEditing: (prevState: boolean) => void;
}

export const CloseCreateChannel = ({ setIsCreating, setIsEditing }: CloseCreateChannelProps) => (
  <svg
    width='32'
    height='32'
    viewBox='0 0 32 32'
